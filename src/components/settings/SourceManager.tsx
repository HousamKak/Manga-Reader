...
import { Check, Edit2, Plus, Power, Trash2, X } from "lucide-react";
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                patternType: e.target.value as SourcePatternType,
              })
            }
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setFormData({ ...formData, chapterFormat: e.target.value })
            }
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex items-center gap-1">
                  ...
                  >
                    <Power
                      className={`h-4 w-4 ${
                        source.isActive ? "text-green-600" : "text-stone-400"
                      }`}
                    />
                  </Button>
                  <Button
